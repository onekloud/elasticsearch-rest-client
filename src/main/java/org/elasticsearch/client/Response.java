...
/**
 * Holds an elasticsearch response. It wraps the {@link HttpResponse} returned and associates it with its corresponding {@link RequestLine} and {@link HttpHost}
 * .
 */
public final class Response {
	static JsonSlurper jsonSlurper = new JsonSlurper(); // [type:JsonParserType.CHAR_BUFFER]
	...
	/**
	 * Returns the value of the first header with a specified name of this message. If there is more than one matching header in the message the first element
	 * is returned. If there is no matching header in the message <code>null</code> is returned.
	 */
